...
\cvevent{Software Developement Engineer II }{Oracle ( Oracle Cloud Infrastructure )}{February 2020 -- Present}{Bengaluru,India}
\begin{itemize}
...
\cvskill{Python, TCP/IP, Unix, Wireshark, AWS, OCI}{5}
%\divider
\cvskill{Docker, Kubernetes, Grafana, Bash}{4}
...
%\divider
\cvevent{Bachelor of Technology, Computer Science}{Cochin University Of Science And Technology}{ May 2013 -- May 2017}{Kochi}
% \divider
